...
├── operations/     # 139 operation detail files
├── schemas/        # 82 schema groups, 217 schema files
├── business-rules.md
...
- **Core - Users** → `references/resources/Core-Users.md` (3 ops) - Provide one endpoint to list all organizations that the authencticated user has access.
