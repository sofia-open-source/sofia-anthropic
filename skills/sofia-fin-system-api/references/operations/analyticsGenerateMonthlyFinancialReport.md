# GET /analytics/financial-records/aggregated-monthly/report

**Resource:** [Analytics - Financial Records Reports](../resources/Analytics-Financial-Records-Reports.md)
**Generate monthly financial report for the last 12 months.**
**Operation ID:** `analyticsGenerateMonthlyFinancialReport`
...
| `groupingDate` | query | enum: dueDate, cashDate, competenceDate | No | Date field used to group records by month. Defaults to "dueDate". Records without the selected date are excluded. |
...
[MonthlyFinancialReportEntity](../schemas/Monthly/MonthlyFinancialReportEntity.md)
