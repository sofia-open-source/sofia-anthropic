# POST /core/financial-records/export/sync

**Resource:** [Core - Financial Records Export](../resources/Core-Financial-Records-Export.md)
**Solicita a exportação dos lançamentos financeiros de forma síncrona.**
**Operation ID:** `coreSyncExportFinancialRecords`
...
[SyncExportFinancialRecordsResponseDto](../schemas/Sync/SyncExportFinancialRecordsResponseDto.md)
