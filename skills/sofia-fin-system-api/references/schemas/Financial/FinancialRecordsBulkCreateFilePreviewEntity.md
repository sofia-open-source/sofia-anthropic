...
|-------|------|----------|-------------|
| `file` | object | Yes |  |
| `nFinancialRecords` | number | Yes |  |
| `previewStatus` | enum: OK, VERY_LARGE_FILE, ERROR | Yes |  |
| `errorMessage` | string | No |  |
| `limit` | number | No |  |
| `financialRecords` | object[] | No |  |
...
#### `financialRecords.populatedFiles`
...
#### `financialRecords.populatedSubcategory`
...
#### `financialRecords.populatedContact`
...
#### `financialRecords.populatedTags`
...
#### `financialRecords.populatedAccount`
...
#### `financialRecords.populatedGroups`
