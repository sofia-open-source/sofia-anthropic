...
| `frequency` | enum: WEEKLY, MONTHLY, YEARLY | No | Frequência de repetição do lançamento. |
| `repetitionDay` | number | No | Dia de repetição do lançamento. |
