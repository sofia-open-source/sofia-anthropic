# RecurringFinancialRecordsPageResponseDto
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `id` | string | Yes | Identificador do lançamento financeiro recorrente. |
...
| `firstOccurrenceDate` | string | No | Data da primeira ocorrência do registro financeiro recorrente. Esta data é obrigatória e deve ser uma string no formato ISO sem hora. |
...
| `amount` | string | Yes | Valor do registro financeiro recorrente. Deve ser uma string representando um número. |
...
| `createdAt` | string | Yes | Creation date of the recurring financial record. |
| `updatedAt` | string | Yes | Last update date of the recurring financial record. |
